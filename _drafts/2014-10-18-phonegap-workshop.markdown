...
**Instalar [Android SDK](http://developer.android.com/sdk/index.html)**.
...
**Instalar [Open JDK](http://openjdk.java.net/)**

	$ sudo apt-get install openjdk-7-jre

**Instalar [Apache Ant](http://ant.apache.org/)**. 

Si selecionas Android Studio, podrás saltarte este paso, ya viene configurado con [Gradle](http://www.gradle.org/).
